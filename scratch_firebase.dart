    ...
    return [
      {
        ...
        'profilePictureUrl': '',
        'mobile': '+91 98765 43210',
        'content': 'Successfully closed a Γé╣50 Lakh commercial loan for a client in under 4 days through HDFC Banker portals. Kudos to the Dhankund team for smooth networking!',
        'imageUrl': 'intellij.png',
    ...
    _cachedBankPolicies = [
      {
        ...
        'vertical': 'DSA',
        'min_cibil': 720,
        'min_income': 'Γé╣35,000 / mo',
        'min_ticket_size': 'Γé╣1,00,000',
        'max_ticket_size': 'Γé╣40,00,000',
        'ticket_size': 'Γé╣1 Lakh - Γé╣40 Lakh',
        'max_loan_amount': 'Γé╣40,00,000',
      ...
      },
      {
        ...
        'vertical': 'Connector',
        'min_cibil': 700,
        'min_income': 'Γé╣50,00,000 / yr',
        'min_ticket_size': 'Γé╣5,00,000',
        'max_ticket_size': 'Γé╣75,00,000',
        'ticket_size': 'Γé╣5 Lakh - Γé╣75 Lakh',
        'max_loan_amount': 'Γé╣75,00,000',
        'ltv_ratio': 'N/A (Unsecured)',
        'm_profile_allowed': 'YES',
        'max_allowed_bounces': 1,
        'geo_radius': '60 km radius',
        'login_fee': 'Γé╣2,500 + GST',
        'interest_rate': '13.00% - 16.00%',
        'processing_fee': '1.50%',
        'special_features': 'No collateral required up to Γé╣50 Lakh. GST & Banking surrogate programs accepted.',
        'tat_days': '4 Days',
        'updated_at': now,
      },
      {
        ...
        'vertical': 'Direct',
        'min_cibil': 700,
        'min_income': 'Γé╣30,000 / mo',
        'min_ticket_size': 'Γé╣10,00,000',
        'max_ticket_size': 'Γé╣5,00,00,000',
        'ticket_size': 'Γé╣10 Lakh - Γé╣5 Crore',
        'max_loan_amount': 'Γé╣5,00,00,000',
        'ltv_ratio': 'Up to 90% LTV',
        'm_profile_allowed': 'YES',
        'max_allowed_bounces': 1,
        'geo_radius': '75 km radius',
        'login_fee': 'Γé╣3,000 flat',
        'interest_rate': '8.40% - 9.15%',
        'processing_fee': 'Γé╣3,000 flat',
      ...
      },
      {
        ...
        'vertical': 'DSA',
        'min_cibil': 700,
        'min_income': 'Γé╣25,000 / mo',
        'min_ticket_size': 'Γé╣50,000',
        'max_ticket_size': 'Γé╣50,00,000',
        'ticket_size': 'Γé╣50,000 - Γé╣50 Lakh',
        'max_loan_amount': 'Γé╣50,00,000',
        'ltv_ratio': 'N/A (Unsecured)',
        'm_profile_allowed': 'YES',
        'max_allowed_bounces': 1,
      ...
      },
      {
        ...
        'vertical': 'Connector',
        'min_cibil': 680,
        'min_income': 'Γé╣30,00,000 / yr',
        'min_ticket_size': 'Γé╣10,00,000',
        'max_ticket_size': 'Γé╣1,00,00,000',
        'ticket_size': 'Γé╣10 Lakh - Γé╣1 Crore',
        'max_loan_amount': 'Γé╣1,00,00,000',
      ...
      },
      {
        ...
        'min_income': 'Γé╣25,000 / mo',
        'min_ticket_size': 'Γé╣5,00,000',
        'max_ticket_size': 'Γé╣10,00,00,000',
        'ticket_size': 'Γé╣5 Lakh - Γé╣10 Crore',
        'max_loan_amount': 'Γé╣10,00,00,000',
        'ltv_ratio': '85% - 90% LTV',
        'm_profile_allowed': 'YES',
        'max_allowed_bounces': 0,
      ...
      },
      {
        ...
        'vertical': 'DSA',
        'min_cibil': 680,
        'min_income': 'Γé╣22,000 / mo',
        'min_ticket_size': 'Γé╣1,00,000',
        'max_ticket_size': 'Γé╣35,00,000',
        'ticket_size': 'Γé╣1 Lakh - Γé╣35 Lakh',
        'max_loan_amount': 'Γé╣35,00,00,000',
        'ltv_ratio': 'N/A (Unsecured)',
        'm_profile_allowed': 'NO',
        'max_allowed_bounces': 2,
        'geo_radius': '40 km radius',
        'login_fee': 'Γé╣1,000 + GST',
      ...
      },
      {
        ...
        'vertical': 'DSA',
        'min_cibil': 730,
        'min_income': 'Γé╣40,000 / mo',
        'min_ticket_size': 'Γé╣20,00,000',
        'max_ticket_size': 'Γé╣7,50,00,000',
        'ticket_size': 'Γé╣20 Lakh - Γé╣7.5 Crore',
        'max_loan_amount': 'Γé╣7,50,00,000',
        'ltv_ratio': '80% - 85% LTV',
        'm_profile_allowed': 'YES',
        'max_allowed_bounces': 0,
        'geo_radius': '60 km radius',
      ...
      },
      {
        ...
        'vertical': 'DSA',
        'min_cibil': 650,
        'min_income': 'Γé╣20,00,000 / yr',
        'min_ticket_size': 'Γé╣3,00,000',
        'max_ticket_size': 'Γé╣45,00,000',
        'ticket_size': 'Γé╣3 Lakh - Γé╣45 Lakh',
        'max_loan_amount': 'Γé╣45,00,000',
      ...
      },
      {
        ...
        'vertical': 'Connector',
        'min_cibil': 660,
        'min_income': 'Γé╣20,000 / mo',
        'min_ticket_size': 'Γé╣1,00,000',
        'max_ticket_size': 'Γé╣25,00,000',
        'ticket_size': 'Γé╣1 Lakh - Γé╣25 Lakh',
        'max_loan_amount': 'Γé╣25,00,00,000',
        'ltv_ratio': 'N/A (Unsecured)',
        'm_profile_allowed': 'YES',
        'max_allowed_bounces': 2,
        'geo_radius': '35 km radius',
