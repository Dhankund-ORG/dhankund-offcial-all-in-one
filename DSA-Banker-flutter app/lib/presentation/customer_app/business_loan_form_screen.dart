        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Container(
              ...
              decoration: const BoxDecoration(color: Color(0x1A27AE60), shape: BoxShape.circle),
              child: const Icon(Icons.check_circle_rounded, color: Color(0xFF27AE60), size: 64),
            ),
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Column(children: [
        ...
        Container(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 6), decoration: BoxDecoration(color: const Color(0x144A3AFF), borderRadius: BorderRadius.circular(20)), child: const Text('Business Loan Application', style: TextStyle(fontSize: 12, color: Color(0xFF4A3AFF), fontWeight: FontWeight.bold))),
      ]),
    );
  }
  ...
  Widget _buildFormCard() {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _buildTextField(controller: _turnoverController, hint: 'Enter your annual turnover', prefix: 'Rs ', keyboardType: TextInputType.number, validator: (v) { if (v == null || v.trim().isEmpty) return 'Please enter your annual turnover'; final n = double.tryParse(v.trim()); return (n == null || n <= 0) ? 'Please enter a valid turnover amount' : null; }),
        const SizedBox(height: 32),
